					...
					opadre.frames["frame_contenidos"].document.location.href=href2
						...
						switch(op){
							...
							case 22: 		
									...
									break;
							case 23:  
									opadre.frames["frame_contenidos"].document.location.href="soporte/soporte.php"
									break;
						}
				}
		}
						...
						<TABLE  class=menupral align=left cellPadding=1 cellSpacing=0 >
						  <TR valign=baseline>
							...
							<?php }?>
											...
											&nbsp;<A href="#" style="text-decoration: none"><IMG border=0 src="./images/iconos/email.gif">&nbsp;<SPAN class=menupral ><?php echo  $TbMsg[17] ?></SPAN></A>&nbsp;</TD>
											<TD width=4 align=middle><IMG src="./images/iconos/separitem.gif"></TD>
